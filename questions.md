...
Последовательности одинаковых типов можно сравнивать. Сравнения происходят в лексикографическом порядке: сначала сравниваются первые элементы обеих последовательностей. Если они различаются, результат сравнения определяется этими элементами. В случаи равенства, происходит переход к сравнению следующих элементов и продолжается до тех пор, пока не найдется различие или пока не закончатся элементы одной из последовательностей. Если все элементы до конца одной из последовательностей равны, более короткая последовательность считается меньшей.
